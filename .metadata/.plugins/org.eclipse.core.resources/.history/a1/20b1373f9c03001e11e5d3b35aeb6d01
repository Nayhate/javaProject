...
public static void listar() {	
			...
			case 1:{				
				...
				for (int i = 0; i < Banco.sorvetes.size(); i++) {
					...
					Prompt.imprimir("ID: " + sorvete.getId());
					Prompt.imprimir("----------------------");
				}
				TelaDeGerenciamentoDeProduto.mostrar();
				break;
			...
			case 2:{
				...
				for (int i = 0; i < Banco.bebidas.size(); i++) {
					...
					Prompt.imprimir("ID: " + bebida.getId());
			...
			case 3:{
				...
				for (int i = 0; i < Banco.adicionais.size(); i++) {
					...
					Prompt.imprimir("ID: " + adicional.getId());
					Prompt.imprimir("----------------------");
				}
					TelaDeGerenciamentoDeProduto.mostrar();
				break;				
...
//Adicionar <-------------------------------------------------------------------->
		...
		public static void adicionar() {
			...
			case 2: {				
				...
				CadastroSorvete.adicionar(new Bebida (nome, sabor, preco, id, tipo, fabricante, marca, tamanho));
				TelaDeGerenciamentoDeProduto.mostrar();
				break;			
			}
			case 3:{
				...
				CadastroSorvete.adicionar(new Adicional (nome, sabor, preco, id));
				TelaDeGerenciamentoDeProduto.mostrar();
				break;
			}
			case 4: {				
